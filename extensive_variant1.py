...
scenario_vec = [100, 1000, 5000, 7000, 10000, 15000, 20000, 25000, 30000, 37000, 45000, 50000, 60000, 70000, 75000, 80000,  85000, 90000,  100000, 105000]
...
t_mat = np.zeros((len(scenario_vec), len(seed_vec)))
obj_mat = np.zeros((len(scenario_vec), len(seed_vec)))
cut_count_mat = np.zeros((len(scenario_vec), len(seed_vec)))
cb_cuts_mat = np.zeros((len(scenario_vec), len(seed_vec)))

for i in range(len(scenario_vec)): 
    
    for j in range(len(seed_vec)):
        ...
        pp = ProductionPlanningProblem(10,5,3, instance_no=seed_vec[j])
        ...
        Y, D = pp.generate_sample(scenario_vec[i],seed_vec[j])
